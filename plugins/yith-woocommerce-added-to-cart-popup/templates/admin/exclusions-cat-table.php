...
<div class="wrap">
	...
	<form id="yith-add-exclusion-cat" method="POST">
		...
		<input type="text" id="add_categories" name="add_categories" class="wc-product-search" data-multiple="true" placeholder="<?php _e( 'Search category...', 'yith-woocommerce-added-to-cart-popup' ) ?>" data-action="yith_wacp_search_categories" />

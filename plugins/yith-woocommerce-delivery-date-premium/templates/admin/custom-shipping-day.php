...
<div id="yith_wcdd_panel_shipping_day">
    <form id="plugin-fw-wc" class="shipping-day-table" method="post">
        ...
        <div class="yith-wcdd-new-shipping-day-cat">
            ...
            <input type="hidden" name="yith_new_shipping_day_cat[category]" class="yith-categories-select wc-product-search" data-action="search_product_category" value="" data-placeholder="<?php _e( 'Search for a category&hellip;', 'yith-woocommerce-delivery-date' ); ?>" style="width: 300px;" />
     ...
     ?>   
        ...
        <div class="yith-wcdd-new-shipping-day-prod">
            <h4><?php _e( 'Add new', 'yith-woocommerce-delivery-date' ) ?></h4>
            <input type="hidden" name="yith_new_shipping_day_prod[product]" class="yith-products-select wc-product-search"  value="" data-placeholder="<?php _e( 'Search for a product&hellip;', 'yith-woocommerce-delivery-date' ); ?>" style="width: 300px;" />

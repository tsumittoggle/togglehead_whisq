...
if( !class_exists( 'YITH_Delivery_Date_Admin' ) ) {
    ...
    class YITH_Delivery_Date_Admin
    {
        ...
        public function enqueue_admin_scripts()
        {
            ...
            if( $is_carrier_post_type || $is_processing_method_post_type ) {

                wp_enqueue_script( 'select2', WC()->plugin_url() . '/assets/js/select2/select2' . $suffix . '.js', array( 'jquery' ), '3.5.4' );
                wp_enqueue_script( 'wc-enhanced-select', WC()->plugin_url() . '/assets/js/admin/wc-enhanced-select' . $suffix . '.js', array( 'jquery', 'select2' ), WC()->version );
        ...
        public function add_processing_category_day()
        {
            ...
            if( isset( $_POST['yith_new_shipping_day_cat'] ) ) {
        ...
        public function add_processing_product_day()
        {
            ...
            if( isset( $_POST['yith_new_shipping_day_prod'] ) ) {

 ...
 */
function whisq_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'whisq_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.whisq-front-page) .entry-title,
...
.colors-custom .whisq-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.whisq-front-page .panel-content .recent-posts article,
...
.colors-custom.whisq-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'whisq_custom_colors_css', $css, $hue, $saturation );
}
